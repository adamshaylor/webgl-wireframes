...
const gui = new dat.GUI({ load: require('./gui.json'), preset: 'Abrahams' });
...
function setupGUI () {
  ...
  shader.add(guiData, 'distanceFactor', 1.0, 1000.0).name('Distance factor').onChange(updateUniforms);
